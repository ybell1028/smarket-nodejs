...
// GET api/crawling/detail/review?query=item_title - 아이템 이름으로 리뷰 정보 검색 
router.get("/detail/review", crawlingController.reView);

// GET api/crawling/detail/news?query=item_title - 아이템 이름으로 뉴스 정보 검색 
router.get("/detail/news", crawlingController.itemNews);
